...
const TaskCard = ({title,description,priority,status,progress,createdAt,dueDate,assignedTo,attachmentCount,completedTodoCount,todoChecklist,onClick}) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-gray-100 py-4 border border-gray-200/50 shadow-md cursor-pointer " 
    onClick={onClick}> 
        ...
        <div className={`px-4 border-l-[3px] ${
          ...
          <div className="px-4">
            ...
            <div className="flex items-center justify-between mt-3">
              ...
              {attachmentCount > 0 && (
                <div className="flex items-center bg-blue-50 py-1.5 px-2.5 rounded-lg">
